...
public class GetAbsencesByDni extends NetConfiguration implements Runnable {
    ...
    public GetAbsencesByDni() { super(); }

    public GetAbsencesByDni(String dni, String access) {
        super();
        this.dni = dni;
        this.access = access;
    }
