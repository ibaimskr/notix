...
public class UpdateGradeEdition extends NetConfiguration implements Runnable{
    ...
    public UpdateGradeEdition(int grade_edition_id, GradeEdition gradeEditionRequest, String token) {
