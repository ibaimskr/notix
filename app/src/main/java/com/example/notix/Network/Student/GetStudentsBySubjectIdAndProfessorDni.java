...
public class GetStudentsBySubjectIdAndProfessorDni extends NetConfiguration implements Runnable {

    private final String theUrl = theBaseUrl + "students/subjects/";
    private String professor_dni;
    private int subject_id;
    private ArrayList<Student> response = new ArrayList<>();
    private String access = "";

    public GetStudentsBySubjectIdAndProfessorDni(int subject_id, String professor_dni, String access) {
        super();
    ...
    public void run() {
        try {
            // The URL
            URL url = new URL(theUrl + subject_id + "/professorDni/" + professor_dni);
